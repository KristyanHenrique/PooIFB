public class Main {
    public static void main(String[] args) {
        ...
        EstudoDirigido estudoDirigido1 = new EstudoDirigido("Estudo Dirigido 1", 0.0, "Matemática", 10);
...
public abstract class Avaliacao {
   ...
   public Avaliacao(String nome, double nota) {
        if (nota <= 0) {
            try {
                throw new IllegalArgumentException("A nota da avaliação deve ser maior que zero.");
